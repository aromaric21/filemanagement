package net.romaric.filemanagement.exception;

import net.romaric.filemanagement.dto.ApiResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse> handleMalformedURLException(MalformedURLException ex){
        return ResponseEntity.badRequest().body(new ApiResponse(false, "File is too long"));
    }
