package net.romaric.filemanagement.service.impl;

import net.romaric.filemanagement.config.FileStorageProperties;
import net.romaric.filemanagement.entity.FileEntity;
import net.romaric.filemanagement.exception.FileNotFoundException;
import net.romaric.filemanagement.exception.FileStorageException;
import net.romaric.filemanagement.repository.FileRepository;
import net.romaric.filemanagement.service.FileService;
...
public class FileServiceImpl implements FileService {
    ...
    public Resource loadFileAsResource(String fileName) {
        try {
            ...
            throw new FileStorageException("File no found" + fileName, ex);
